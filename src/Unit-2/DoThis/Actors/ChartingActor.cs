...
namespace ChartApp.Actors
{
    public class ChartingActor : ReceiveActor, IWithUnboundedStash
    {
        ...
        public void HandleInitialize(InitializeChart ic)
        {
        ...
        public void HandleAddSeries(AddSeries series)
        {
       ...
       !_seriesIndex.ContainsKey(series.Series.Name))
        ...
        public void HandleRemoveSeries(RemoveSeries series)
        {
        ...
        public void HandleMetrics(Metric metric)
        {
